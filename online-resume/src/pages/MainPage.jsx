...
const MainPage = () => {
  const LinkedinLink =
    "https://www.linkedin.com/in/alexandre-arabian-jensezian";
  ...
  const {
    ...
    inView: aboutInView,
    entry: aboutEntry,
  } = useInView({ rootMargin: "0px", threshold: 0 });
  const {
    ref: experienceRef,
    inView: experienceInView,
    entry: experienceEntry,
  } = useInView({ rootMargin: "-50px", threshold: 0 });
      ...
      <div className="main-page">
        ...
        <section className="section">
          <header className="header">
            <h1>
              <span className={`color-glow-word ${isGlowing ? "glowing" : ""}`}>
                Computer
              </span>{" "}
              Engineer,{" "}
              <span className={`color-glow-word ${isGlowing ? "glowing" : ""}`}>
          ...
          <div className="links">
            ...
            <DownloadElement
              type="link"
              url="mailto:alexandre.arabian.j@gmail.com"
              icon={faEnvelope}
            >
              Email
            </DownloadElement>
        ...
        <section
          ref={aboutRef}
          id="about"
          className={`section ${aboutIsVisible ? "" : "hidden-section"}`}
        >
        ...
        <section
          ref={experienceRef}
          id="experience"
          className={`section ${experienceIsVisible ? "" : "hidden-section"}`}
        >
        ...
        <footer id="contact" className="footer">
          <p>
            Contact:{" "}
            <a
              href="mailto:alexandre.arabian.j@gmail.com"
              title="alexandre.arabian.j@gmail.com"
            >
              alexandre.arabian.j@gmail.com
            </a>
          </p>
        </footer>
      </div>
